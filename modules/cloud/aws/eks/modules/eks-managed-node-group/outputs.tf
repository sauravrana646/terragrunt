...
output "iam_role_name" {
  ...
  value       = try(module.eks_node_group_iam_role[0].iam_role_name, null)
}

output "iam_role_arn" {
  description = "The Amazon Resource Name (ARN) specifying the IAM role"
  value       = try(module.eks_node_group_iam_role[0].iam_role_arn, var.iam_role_arn)
}

output "iam_role_unique_id" {
  description = "Stable and unique string identifying the IAM role"
  value       = try(module.eks_node_group_iam_role[0].iam_role_unique_id, null)
}

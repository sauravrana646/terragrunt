...
variable "iam_role_additional_policies" {
  type        = list(any)
  description = "Additonal IAM Role Policies"
  default     = []
}
...
variable "cluster_ingress_with_cidr_blocks" {
  description = "Additional Cluster Security Group Rule with CIDR Blocks"
  type        = list(map(string))
  default     = []
}

variable "cluster_ingress_with_source_security_group_id" {
  type        = list(map(string))
  description = "Additional Security Group Rule with source security group ID"
  default     = []
}
...
variable "node_security_group_ingress_with_sg" {
  type    = list(map(string))
  default = []
}

variable "node_security_group_ingress_with_self" {
  type    = list(map(string))
  default = []
}

variable "node_security_group_ingress_with_cidr_blocks" {
  type    = list(map(string))
  default = []
}

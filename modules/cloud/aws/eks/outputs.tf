...
output "cluster_security_group_arn" {
  ...
  value       = try(module.cluster_security_group.security_group_arn, null)
}

output "cluster_security_group_id" {
  description = "ID of the cluster security group"
  value       = try(module.cluster_security_group.security_group_id, null)
}
...
output "node_security_group_arn" {
  ...
  value       = try(module.node_security_group.security_group_arn, null)
}

output "node_security_group_id" {
  description = "ID of the node shared security group"
  value       = try(module.node_security_group.security_group_id, null)
}
...
output "cluster_iam_role_name" {
  ...
  value       = try(module.eks_iam_role.iam_role_name, null)
}

output "cluster_iam_role_arn" {
  description = "IAM role ARN of the EKS cluster"
  value       = try(module.eks_iam_role.iam_role_arn, null)
}

output "cluster_iam_role_unique_id" {
  description = "Stable and unique string identifying the IAM role"
  value       = try(module.eks_iam_role.iam_role_unique_id, null)
}

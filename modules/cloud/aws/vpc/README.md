...
| <a name="input_vpc_cidr_block"></a> [vpc\_cidr\_block](#input\_vpc\_cidr\_block) | CIDR block for the AWS VPC | `string` | n/a | yes |
...
| <a name="input_create_default_route_table"></a> [create\_default\_route\_table](#input\_create\_default\_route\_table) | Should be true to manage default route table | `bool` | `false` | no |
| <a name="input_create_default_security_group"></a> [create\_default\_security\_group](#input\_create\_default\_security\_group) | Should be true to adopt and manage default security group | `bool` | `false` | no |
...
| <a name="input_create_vpc"></a> [create\_vpc](#input\_create\_vpc) | Controls the creation of VPC Module and its resources | `bool` | `true` | no |
...
| <a name="input_enable_dns_hostnames"></a> [enable\_dns\_hostnames](#input\_enable\_dns\_hostnames) | Enable the DNS Hostname for VPC | `bool` | `true` | no |
| <a name="input_enable_dns_support"></a> [enable\_dns\_support](#input\_enable\_dns\_support) | Enable the DNS Support for VPC | `bool` | `true` | no |
...
| <a name="input_name"></a> [name](#input\_name) | Name for all resources | `string` | `""` | no |
